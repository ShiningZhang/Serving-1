...
if (WITH_GPU)
    ...
    elseif(CUDA_VERSION EQUAL 11.2)
        ...
        set(WITH_TRT ON)
        if (WITH_ARM)
            set(CUDA_SUFFIX "arm64_gcc7.3_openblas_cuda11.2_cudnn8.1.1")
            set(WITH_TRT OFF)
        endif(WITH_ARM)
    endif()
else()
...
elseif(WITH_ARM)
    SET(PADDLE_LIB_PATH "https://paddle-serving.bj.bcebos.com/inferlib/${PADDLE_LIB_VERSION}/paddle_inference.tgz")
else()
...
if ((WITH_GPU OR WITH_MKLML) AND NOT WITH_ARM)
    if (WITH_TRT)
        ExternalProject_Add(
            "extern_paddle"
